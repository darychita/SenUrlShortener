...
router.post('/register', validate(registrationValidation), userHandlers.createUser);
...
router.post('/reset/:token', validate(passwordValidation), userHandlers.confirmResetPassword);
